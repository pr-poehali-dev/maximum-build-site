      ...
      <section className="py-20 bg-muted">
        <div className="container mx-auto px-4">
          ...
          <p className="text-xl text-center text-muted-foreground max-w-3xl mx-auto">
            Максимум Строй — надежный партнер в строительстве
          </p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-lg text-muted-foreground">
                <p>
                  Компания "Максимум Строй" работает на строительном рынке с 2005 года. 
                  За это время мы реализовали более 500 проектов различной сложности — 
                  от частных домов до крупных промышленных комплексов.
                </p>
                <p>
                  Наша команда состоит из высококвалифицированных специалистов: 
                  архитекторов, инженеров, прорабов и строителей. Каждый проект мы 
                  выполняем с максимальным вниманием к деталям и соблюдением всех 
                  технологических норм.
                </p>
                <p>
                  Мы гордимся нашей репутацией надежного подрядчика и стремимся 
                  к долгосрочному сотрудничеству с каждым клиентом.
                </p>
              </div>
            </div>
            <div>
