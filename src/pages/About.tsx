      ...
      <section className="py-20 bg-muted">
        <div className="container mx-auto px-4">
          ...
          <p className="text-xl text-center text-muted-foreground max-w-3xl mx-auto">
            ООО "Максимум Строй" — строительная компания в Калининграде
          </p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-lg text-muted-foreground">
                <p>
                  <strong>ОБЩЕСТВО С ОГРАНИЧЕННОЙ ОТВЕТСТВЕННОСТЬЮ "МАКСИМУМ СТРОЙ"</strong> (ИНН 3900039662, ОГРН 1253900003917, КПП 390001001) — 
                  строительная компания, зарегистрированная в Калининграде. Наш основной вид деятельности — 
                  строительство жилых и нежилых зданий (ОКВЭД 41.20). Мы реализуем проекты различной сложности — 
                  от частных домов до крупных коммерческих и государственных объектов.
                </p>
                <p>
                  Компанией руководит <strong>генеральный директор Бычковский Максим Игоревич</strong>. 
                  Мы специализируемся на комплексном строительстве жилых домов, коттеджей, 
                  коммерческих и промышленных объектов. Все работы выполняются в соответствии 
                  с действующими СНиП и ГОСТ.
                </p>
                <p>
                  <strong>Юридический адрес:</strong> 236034, Калининградская область, город Калининград, 
                  улица Левитана, дом 61, квартира 10. Мы предлагаем полный цикл строительных услуг: 
