      ...
      <section className="py-20 bg-muted">
        <div className="container mx-auto px-4">
          ...
          <p className="text-xl text-center text-muted-foreground max-w-3xl mx-auto">
            ООО "Максимум Строй" — ваш надежный партнер в строительстве с 2010 года
          </p>
        </div>
      </section>
            ...
            <div>
              ...
              <div className="space-y-4 text-lg text-muted-foreground">
                <p>
                  ...
                  рынке Москвы и Московской области с 2010 года. За это время мы реализовали 
                  более 350 проектов различной сложности — от частных домов до крупных государственных объектов.
                </p>
                <p>
